...
const [isPwdShown, setIsPwdShown] = useState(false);
  ...
  return (
    <>
    <main className='bg-black px-4 py-5 h-screen flex items-center justify-center'>
        <div id='White_box' className=''>
            <img src={getImageUrl("tickitz-white", "png")} alt="" />
            <form onSubmit={submitHandler} className='bg-white flex flex-col gap-4 px-2 py-4 rounded-md text-sm'>
                <p className='text-xl'>Welcome Back👋</p>
                <p className='text-secondary'>Sign in with your data that you entered during your registration</p>
                <div id='Email'>
                    <p>Email</p>
                ...
                <a href="#" className='text-primary flex justify-end'>Forgot your password?</a>
